...
public class NotificationController {
    ...
    @PutMapping("/read-all")
    public Response<String> readAllNotificationByTargetId(@AuthPrincipal @Parameter(hidden = true) MemberPrincipal memberPrincipal) {
    ...
    @PutMapping("/read/{id}")
    public Response<String> readNotificationById(@AuthPrincipal @Parameter(hidden = true) MemberPrincipal memberPrincipal,
    ...
    @GetMapping("/count")
    public Response<Integer> countNotReadNotification(@AuthPrincipal @Parameter(hidden = true) MemberPrincipal memberPrincipal
    ) {
    ...
    @GetMapping
    public Response<PaginationModel<GetNotificationResponseDto>> getNotifications(@AuthPrincipal @Parameter(hidden = true) MemberPrincipal memberPrincipal
