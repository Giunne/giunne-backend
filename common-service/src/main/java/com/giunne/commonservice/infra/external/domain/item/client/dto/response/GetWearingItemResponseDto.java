package com.giunne.commonservice.infra.external.domain.item.client.dto.response;
...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "장착중인 아이템 미리보기 검색 응답DTO")
public class GetWearingItemResponseDto {
